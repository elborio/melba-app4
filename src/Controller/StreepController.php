...
class StreepController extends Controller
{
    ...
    public function getBeerTotalForCurrentUser() {
        $amount = $this->getDoctrine()->getRepository("App:BeerMark")->getBeerCountForUser($this->getUser());
        return $amount;

    }
    public function getBeerTotalForCurrentGroup() {
        $amount = $this->getDoctrine()->getRepository("App:BeerMark")->getBeerCountForGroup($this->getUser()->getCurrentGroup());
        return $amount;
    ...
    {
        $amount = $this->getDoctrine()->getRepository("App:BeerMark")->getBeerCountForGroupLastWeek($this->getUser()->getCurrentGroup());
        return $amount;
    }
